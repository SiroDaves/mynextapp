  ...
  return (
    <Dialog open={openSidebar} onOpenChange={toggleSidebar}>
      <DialogContent className=" w-full sm:max-w-full sm:max-h-screen">
        ...
        <h3 className="text-center pt-2 font-semibold">App Portal</h3>
        <div className="pt-5 flex-grow flex flex-col">
          ...
          <div className="flex items-center justify-center">
            <Button
              variant={"outline"}
              className="border-destructive text-destructive rounded-lg px-6"
              onClick={() => signOut()}
            >
              <span>
                <LogOutIcon className="mr-3 flex-shrink-0 h-6 w-6 stroke-[1px]" />
              </span>
              Sign out
            </Button>
          </div>
