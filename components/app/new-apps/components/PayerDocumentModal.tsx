...
export const PayerDocumentModal = ({ }) => {
  ...
  const onSubmit = async (data: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      await uploadDocument(params.id, personalDetail?.identificationNumber, type, "PAYER", contentType, fileBase64String);
                  ...
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent defaultValue="Not Selected">
                        ...
                        <SelectItem value="OTHERS">Other Documents</SelectItem>
                      </SelectContent>
                    </Select>
                    <FormMessage />
                    <FormMessage />
