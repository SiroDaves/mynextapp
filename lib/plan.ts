...
export const DisplayQuestion = (key: string) => {
  switch (key) {
    ...
    case "familyMedicalHistoryDetails":
       return `If Yes, give family medical history details`;
    ...
    case "politicalOrRankingOffice":
      return `Do you hold or have ever held a political or high ranking public office?`;
    case "relativePoliticalOrRankingOffice":
      return `Does your close relative/business partner hold or have ever held a political or high ranking public office?`;
    default:
      return key;
  }
};
